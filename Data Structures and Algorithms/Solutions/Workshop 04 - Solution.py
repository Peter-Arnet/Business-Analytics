...
class Monster(object):
    ...
    def heal(self,healing):
        ...
        >>> pika = Monster('Pikachu','electric',100,100)
        >>> pika.health = 50
        >>> pika.heal(10)
    ...
    def use_attack(self,attack,target_monster):
        ...
        If it is, calculate damage fromt the attack as DAMAGE, where
            ...
            print out that the attack is taking place as in the examples below
        ...
        if attack not in self.attacks:
            ...
            damage = int(round(damage * self.combat_points / target_monster.get_combat_points()))
            print(self.name + ' hits ' + str(target_monster) + ' for ' + str(damage) + '!')
